...
namespace LootLocker.Requests
{
    public partial class LootLockerSDKManager
    {
        ...
        public static void WhiteLabelLoginAndStartSession(string email, string password, bool rememberMe, Action<LootLockerWhiteLabelLoginAndStartSessionResponse> onComplete, bool rememberMe1)
        {
